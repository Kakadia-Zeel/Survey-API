...
let db = new sqlite3.Database(DBSOURCE, (err) => {
    if (err) {
        ...
        const question = `CREATE TABLE IF NOT EXISTS question (questionId INTEGER PRIMARY KEY AUTOINCREMENT, surveyId INTEGER NOT NULL, qdetails text, yes INTEGER DEFAULT 0, no INTEGER DEFAULT 0, FOREIGN KEY (surveyId) REFERENCES survey(surveyId))`;
